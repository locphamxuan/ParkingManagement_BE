...
const options = {
  definition: {
    ...
    tags: [
      ...
      { name: 'User - Incidents', description: 'Report and track incidents (violations, facility issues, ...)' },
      ...
      { name: 'Manager - Refund Policy', description: 'Refund policy applied when a long-term subscription is cancelled' },
      { name: 'Manager - Shifts', description: 'Staff shift management' },
      { name: 'Manager - Feedback', description: 'User feedback responses' },
      { name: 'Manager - Incidents', description: 'Resolve incidents; only a manager may apply a penalty fee' },
