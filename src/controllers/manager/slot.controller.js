...
const service = require("../../services/manager/slot.service");
...
const update = asyncHandler(async (req, res) => {
  ...
  sendSuccess(res, { message: "Slot updated", data: { item } });
});
...
const updateStatus = asyncHandler(async (req, res) => {
  ...
  sendSuccess(res, { message: "Slot status updated", data: { item } });
});
